...
struct AboutPanel: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            settingsCard {
                HStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        Text("VoiceToText").font(.title3.weight(.semibold))
            ...
            settingsCard {
                settingsRow("Privacy & Permissions", icon: "lock.shield")
            ...
            settingsCard {
                ...
                dataRow(
                    ...
                    detail: "Preferences, prompt, replacement rules and history. Reset from the button below."
                )
